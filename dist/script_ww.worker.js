...
/* harmony default export */ const script_state = (state);
...
var script_utils_BUF_INC = constants.BUF_INC,
  script_utils_FDEFS = constants.FDEFS,
  script_utils_SBRACKETS = constants.SBRACKETS,
  script_utils_TFSTR = constants.TFSTR;
var tf_cache = {};
function f_args(src) {
  script_utils_FDEFS.lastIndex = 0;
  var m = script_utils_FDEFS.exec(src);
  if (m) {
...
function wrap_idxs(src, pre) {
  ...
  script_utils_SBRACKETS.lastIndex = 0;
  var changed = false;
  var m;
  do {
    m = script_utils_SBRACKETS.exec(src);
    if (m) {
      var vname = m[1].trim();
      var vindex = m[2].trim();
      if (vindex === '0' || parseInt(vindex) < script_utils_BUF_INC) {
        continue;
      }
      switch (vname) {
        case 'let':
...
function tf_from_str(str) {
  ...
  script_utils_TFSTR.lastIndex = 0;
  var m = script_utils_TFSTR.exec(str);
  if (m) {
...
/* harmony default export */ const time = ({
  ...
  dayofmonth: function dayofmonth(time) {
    return new Date(time || script_state.t).getUTCDate();
  },
  ...
  dayofweek: function dayofweek(time) {
    return new Date(time || script_state.t).getUTCDay() + 1;
  },
  ...
  hour: function hour(time) {
    return new Date(time || script_state.t).getUTCHours();
  },
  ...
  minute: function minute(time) {
    return new Date(time || script_state.t).getUTCMinutes();
  },
  /** Month
   * @param {number} [time] - Time in ms (current t, if not defined)
   * @return {number} - Month
  ...
  month: function month(time) {
    return new Date(time || script_state.t).getUTCMonth();
  },
  /** The current time
  ...
  second: function second(time) {
    return new Date(time || script_state.t).getUTCSeconds();
  },
  ...
  weekofyear: function weekofyear(time) {
    var date = new Date(time || script_state.t);
  ...
  year: function year(time) {
    return new Date(time || script_state.t).getUTCFullYear();
  }
});
...
/* harmony default export */ const chart = ({
  ...
  onchart: function onchart(x, name, sett, _id) {
    ...
    off *= script_state.tf;
    var v = Array.isArray(x) ? [script_state.t + off].concat(_toConsumableArray(x)) : [script_state.t + off, x];
  ...
  onclose: function onclose(tf) {
    ...
    if (!tf) tf = script_state.tf;
    return (script_state.t + script_state.tf) % tf_from_str(tf) === 0;
  },
  ...
  signal: function signal(type, data) {
    ...
    if (script_state.shared.event !== 'update') return;
    script_state.send('script-signal', {
      type: type,
      data: data
    });
  },
  ...
  modify: function modify(id, fields) {
    script_state.send('modify-overlay', {
      uuid: id,
      fields: fields
    });
  },
...
/* harmony default export */ const analysis = ({
...
/* harmony default export */ const indicators = ({
  ...
  sar: function sar(start, inc, max, _id, _tf) {
    ...
    var n = _tf ? out.__len__ - 1 : script_state.iter;
    var prev;
    var outSet = false;
    if (n >= 1) {
      prev = out[1];
...
var sampler_DEF_LIMIT = constants.DEF_LIMIT;
/* harmony default export */ function sampler(T, auto) {
  if (auto === void 0) {
    auto = false;
  }
  ...
  return function (x, t) {
    ...
    var id = this.__id__;
    t = t || script_engine.t;
    var val = auto ? script_engine[T][0] : x;
    ...
    this.length = this.__len__ || sampler_DEF_LIMIT;
  };
}
...
var timeseries_BUF_INC = constants.BUF_INC;
/* harmony default export */ const timeseries = ({
  /**
  ...
  _i: function _i(i, x) {
    ...
    if (x != undefined && x === x && x.__id__) {
      ...
      if (!x.__len__ || i >= x.__len__) {
        x.__len__ = i + timeseries_BUF_INC;
      }
    }
    return i;
  },
...
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = symbol_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function symbol_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return symbol_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? symbol_arrayLikeToArray(r, a) : void 0; } }
function symbol_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var Sym = /*#__PURE__*/function () {
  function Sym(data, params) {
    classCallCheck_classCallCheck(this, Sym);
    this.id = params.id;
    ...
    this.tmap = {};
    this.tf = this.tf || script_engine.tf;
    if (this.main) this.tf = script_engine.tf;
    ...
    if (this.aggtype === 'ohlcv') {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var id = _step.value;
          this[id] = TS("".concat(this.id, "_").concat(id), []);
    ...
    if (this.aggtype === 'copy') {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          this[_id] = TS("".concat(this.id, "_").concat(_id), []);
    ...
    if (typeof this.aggtype === 'function') {
      this.close = TS("".concat(this.id, "_close"), []);
      this.close.__fn__ = this.aggtype;
      this.close.__tf__ = this.tf;
    }
    if (this.main) {
      if (!this.tf) throw 'Main tf should be defined';
      script_engine.custom_main = this;
      var t0 = this.data[0][0];
      script_engine.t = t0 - t0 % this.tf;
      this.update(null, script_engine.t);

      // First candle should be formed before any updates()
      script_engine.data.ohlcv.data.length = 0;
      script_engine.data.ohlcv.data.push([script_engine.t, this.open[0], this.high[0], this.low[0], this.close[0], this.vol[0]]);
    }
  }
  return createClass_createClass(Sym, [{
    key: "update",
    ...
    value: function update_ohlcv(x, t) {
      ...
      switch (this.data_type) {
        case ARR:
          ...
          var dt = t0 % this.tf;
          t0 -= dt;
          var i0 = nextt(this.data, t0);
          if (i0 >= this.data.length) return false;
          var t1 = t + script_engine.tf;
...
/* harmony default export */ const symbol = ({
  ...
  sym: function sym(x, y, _id) {
    ...
    switch (_typeof(x)) {
      ...
      case 'string':
        y.tf = x;
        sym = new Sym(script_state.data.ohlcv.data, y);
        sym.data_type = ARR;
        break;
    }
    this.env.syms[id] = sym;
...
function script_std_createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = script_std_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function script_std_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return script_std_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? script_std_arrayLikeToArray(r, a) : void 0; } }
function script_std_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var ScriptStd = /*#__PURE__*/function () {
  function ScriptStd(env) {
    classCallCheck_classCallCheck(this, ScriptStd);
    this.env = env;
    this.se = script_state;
  ...
  return createClass_createClass(ScriptStd, [{
    key: "_index_tracking",
    ...
    value: function _add_i(name, src) {
      ...
      if (src2 !== src) {
        return _construct(Function, _toConsumableArray(args).concat([src2]));
      }
      return null;
    }
...
Object.assign(proto, math);
Object.assign(proto, time);
Object.assign(proto, chart);
Object.assign(proto, utils);
Object.assign(proto, analysis);
Object.assign(proto, indicators);
Object.assign(proto, timeseries);
Object.assign(proto, symbol);
;// ./src/helpers/script_env.js



function script_env_createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = script_env_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function script_env_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return script_env_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? script_env_arrayLikeToArray(r, a) : void 0; } }
function script_env_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var script_env_DEF_LIMIT = constants.DEF_LIMIT,
  script_env_FDEFS1 = constants.FDEFS1,
  script_env_FDEFS2 = constants.FDEFS2;
var ScriptEnv = /*#__PURE__*/function () {
  function ScriptEnv(s, data) {
    classCallCheck_classCallCheck(this, ScriptEnv);
    this.std = script_state.std_inject(new ScriptStd(this));
    this.id = s.uuid;
    this.src = s;
  ...
  return createClass_createClass(ScriptEnv, [{
    key: "build",
    value: function build() {
      this.output.box_maker(this, this.shared, script_state);
    ...
    value: function copy(v, unshift) {
      ...
      var t = script_state.t;
      if (off) t += off * script_state.tf;
      var point;
      if (val == null || !val.length) {
        ...
        // Array
        point = [t].concat(_toConsumableArray(val));
      }
      if (unshift) {
    ...
    value: function make_box(src) {
      ...
      for (var _k2 in src.data || {}) {
        var id = script_state.match_ds(this.id, src.data[_k2].type);
    ...
    value: function make_modules() {
      var s = "";
      for (var id in script_state.mods) {
        if (!script_state.mods[id].api) continue;
    ...
    value: function prep(src) {
      ...
      src = '\t\t  let _pref = `${_id}<-' + h + '<-`\n' + src;
      script_env_FDEFS2.lastIndex = 0;
      var call_id = 0; // Function call id (to make each call unique)
      var m;
      do {
        m = script_env_FDEFS2.exec(src);
        if (m) {
          var fkeyword = m[1].trim();
          var fname = m[2];
          var fargs = m[3];
          if (fkeyword === 'function') {
            ...
            // Quick fix
            script_env_FDEFS2.lastIndex = off;
          }
        }
      } while (m);
    ...
    value: function get_args(src) {
      var reg = this.regex_clone(script_env_FDEFS1);
      reg.lastIndex = 0;
      var m = reg.exec(src);
    ...
    value: function get_args_2(str) {
      ...
      return parts.map(function (x) {
        return str.slice.apply(str, _toConsumableArray(x));
      }).filter(function (x) {
        return /[^\s]+/.exec(x);
      });
    }
...
/* harmony default export */ const stuff_utils = ({
...
function symstd_createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = symstd_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function symstd_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return symstd_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? symstd_arrayLikeToArray(r, a) : void 0; } }
function symstd_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
/* harmony default export */ const symstd = ({
  parse: function parse(s) {
    ...
    var _loop = function _loop() {
      ...
      if (m) {
        var fn = m[1] + m[2];
        var tf = m[2];
        if (fn in script_engine.std_plus) return 1; // continue
        switch (m[1]) {
          case 'tr':
...
function script_engine_createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = script_engine_unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function script_engine_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return script_engine_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? script_engine_arrayLikeToArray(r, a) : void 0; } }
function script_engine_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var script_engine_DEF_LIMIT = constants.DEF_LIMIT;
...
var ScriptEngine = /*#__PURE__*/function () {
  function ScriptEngine() {
    var _this = this;
    classCallCheck_classCallCheck(this, ScriptEngine);
    this.map = {};
    this.data = {};
    this.exec_id = null;
    ...
    script_state.send = function () {
      return _this.send.apply(_this, arguments);
    };
    script_state.std_inject = function () {
      return _this.std_inject.apply(_this, arguments);
    };
    script_state.match_ds = function () {
  ...
  return createClass_createClass(ScriptEngine, [{
    ...
    value: function _computationHash(script) {
      ...
      for (var key in props) {
        if (!DISPLAY_ONLY_SETTINGS.has(key)) {
          ...
          var sv = val !== null && _typeof(val) === 'object' ? JSON.stringify(val) : String(val);
      ...
      for (var _key in sett) {
        if (!DISPLAY_ONLY_SETTINGS.has(_key)) {
          var _sv = sett[_key] !== null && _typeof(sett[_key]) === 'object' ? JSON.stringify(sett[_key]) : String(sett[_key]);
    ...
    value: function syncState() {
      script_state.t = this.t;
      script_state.tf = this.tf;
      script_state.iter = this.iter;
      script_state.data = this.data;
      script_state.shared = this.shared;
      script_state.mods = this.mods;
    }
  }, {
    key: "exec_all",
    value: function exec_all() {
      ...
      this.exec_id = setTimeout(/*#__PURE__*/asyncToGenerator_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee() {
        var id;
    ...
    key: "exec_sel",
    value: function () {
      var _exec_sel = asyncToGenerator_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee2(delta) {
        var _this3 = this;
        ...
        return regenerator_default().wrap(function (_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 9:
              ...
              _iterator2 = script_engine_createForOfIteratorHelper(displayOnlyChanges);
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                  id = _step2.value;
    ...
    value: function update(candles) {
      ...
      try {
        ...
        var _iterator3 = script_engine_createForOfIteratorHelper(candles),
          _step3;
        try {
    ...
    key: "run",
    value: function () {
      var _run = asyncToGenerator_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee3(sel) {
        ...
        return regenerator_default().wrap(function (_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _iterator4 = script_engine_createForOfIteratorHelper(sel);
              try {
    ...
    value: function format_map(sel, range, output) {
      ...
      sel = sel || Object.keys(this.map);
      var res = [];
      var _iterator5 = script_engine_createForOfIteratorHelper(sel),
        _step5;
      try {
        var _loop = function _loop() {
          var id = _step5.value;
          ...
          if (x.output === 'range' || range) {
            var _ref2 = range || _this6.range,
              _ref3 = slicedToArray_slicedToArray(_ref2, 2),
              t1 = _ref3[0],
              t2 = _ref3[1];
            f = function f(arr) {
    ...
    value: function remove_scripts(ids) {
      var _iterator6 = script_engine_createForOfIteratorHelper(ids),
        _step6;
      try {
    ...
    value: function data_required(s) {
      ...
      var _loop2 = function _loop2() {
        ...
        if (sc.src.data) {
          ...
          types.push.apply(types, _toConsumableArray(reqs.map(function (x) {
            return {
              id: sc.uuid,
              type: x.type
            };
...
/* harmony default export */ const script_engine = (new ScriptEngine());
...
var Dataset = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  ...
  return _createClass(Dataset, [{
    ...
    value: function watcher(n, p) {
      ...
      var _iterator = dataset_createForOfIteratorHelper(nMap),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var _iterator2 = dataset_createForOfIteratorHelper(pSet),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _id = _step2.value;
...
var DatasetWW = /*#__PURE__*/function () {
  function DatasetWW(id, data) {
    classCallCheck_classCallCheck(this, DatasetWW);
    this.last_upd = stuff_utils.now();
    this.id = id;
  ...
  return createClass_createClass(DatasetWW, [{
    key: "merge",
    ...
    value: function update_all(se, data) {
      for (var k in data) {
        ...
        se.data[id].last_upd = stuff_utils.now();
      }
    }
  }]);
}();
...
wwGlobal.onmessage = async e => {
    ...
    switch(e.data.type) {
        ...
        case 'exec-script':
            ...
            let req = script_engine.data_required(e.data.data.s)
            ...
            script_engine.tf = tf_from_str(e.data.data.tf)
        ...
        case 'exec-all-scripts':
            ...
            let req2 = script_engine.data_required(e.data.data.s)
        ...
        case 'upload-data':
            ...
            await stuff_utils.pause(1)

            for (let id in e.data.data) {
                let data = e.data.data[id]
                script_engine.data[id] = new DatasetWW(id, data)
            }

            script_engine.recalc_size()
        ...
        case 'upload-module':
            ...
            let lib = make_module_lib(e.data.data)
            script_engine.mods[e.data.data.id] = new (
                new Function(
                    'mod', 'se', 'lib',
                    f_body(e.data.data.main)
                )
            )(e.data.data.id, script_engine, lib)
        ...
        case 'update-data':
            ...
            DatasetWW.update_all(script_engine, e.data.data)
        ...
        case 'get-dataset':
            ...
            wwGlobal.postMessage({
                id: e.data.id,
                data: script_engine.data[e.data.data]
            })
        ...
        case 'dataset-op':
            ...
            if (e.data.data.id in script_engine.data) {
                script_engine.data[e.data.data.id].op(script_engine, e.data.data)
            }

            if (e.data.data.exec) script_engine.exec_all()
