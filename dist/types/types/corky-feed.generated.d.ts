...
export type ChartHistoryRangeLatest = Extract<ChartHistoryRange, {
    type: 'latest';
}>;
export type ChartHistoryRangeStartEnd = Extract<ChartHistoryRange, {
    type: 'start_end';
}>;
export type ChartHistoryRangeSinceInception = Extract<ChartHistoryRange, {
    type: 'since_inception';
}>;
...
export type SearchConditionCompare = Extract<AlertCondition, {
    type: 'compare';
}>;
export type SearchConditionAll = Extract<AlertCondition, {
    type: 'all';
}>;
export type SearchConditionAny = Extract<AlertCondition, {
    type: 'any';
}>;
export type SearchCondition = AlertCondition;
export type SearchSymbolSet = Extract<SearchSymbolScope, {
    type: 'symbols';
}>;
...
export type ListCandleStatesCommand = Extract<ChartClientCommand, {
    type: 'list_candle_states';
}>;
export type ListAuthPositionsCommand = Extract<ChartClientCommand, {
    type: 'list_auth_positions';
}>;
export type ListAuthPositionHistoryCommand = Extract<ChartClientCommand, {
    type: 'list_auth_position_history';
}>;
export type GetAuthPositionAuditCommand = Extract<ChartClientCommand, {
    type: 'get_auth_position_audit';
}>;
export type SubscribeAuthPositionsCommand = Extract<ChartClientCommand, {
    type: 'subscribe_auth_positions';
}>;
export type SubscribeAuthPositionAuditCommand = Extract<ChartClientCommand, {
    type: 'subscribe_auth_position_audit';
}>;
export type SubscribeCandlesCommand = Extract<ChartClientCommand, {
    type: 'subscribe_candles';
}>;
export type SearchCandlesCommand = Extract<ChartClientCommand, {
    type: 'search_candles';
}>;
export type CancelSearchCommand = Extract<ChartClientCommand, {
    type: 'cancel_search';
}>;
export type ListStrategiesCommand = Extract<ChartClientCommand, {
    type: 'list_strategies';
}>;
export type GetStrategyCommand = Extract<ChartClientCommand, {
    type: 'get_strategy';
}>;
export type ListStrategyRuntimesCommand = Extract<ChartClientCommand, {
    type: 'list_strategy_runtimes';
}>;
export type ListStrategyLaunchProfilesCommand = Extract<ChartClientCommand, {
    type: 'list_strategy_launch_profiles';
}>;
export type ListStrategyPromotionsCommand = Extract<ChartClientCommand, {
    type: 'list_strategy_promotions';
}>;
export type GetStrategyPromotionCommand = Extract<ChartClientCommand, {
    type: 'get_strategy_promotion';
}>;
export type GetStrategyRuntimeCommand = Extract<ChartClientCommand, {
    type: 'get_strategy_runtime';
}>;
export type GetStrategyTickerCommand = Extract<ChartClientCommand, {
    type: 'get_strategy_ticker';
}>;
export type GetStrategyChartOverlaysCommand = Extract<ChartClientCommand, {
    type: 'get_strategy_chart_overlays';
}>;
export type ListStrategyDecisionsCommand = Extract<ChartClientCommand, {
    type: 'list_strategy_decisions';
}>;
export type ListStrategyOperationsCommand = Extract<ChartClientCommand, {
    type: 'list_strategy_operations';
}>;
export type GetStrategyMoneyCommand = Extract<ChartClientCommand, {
    type: 'get_strategy_money';
}>;
export type GetStrategyBalanceHistoryCommand = Extract<ChartClientCommand, {
    type: 'get_strategy_balance_history';
}>;
export type GetStrategyAccountMoneyCommand = Extract<ChartClientCommand, {
    type: 'get_strategy_account_money';
}>;
export type CompareStrategyAllocationPoliciesCommand = Extract<ChartClientCommand, {
    type: 'compare_strategy_allocation_policies';
}>;
export type SubscribeStrategyOperationsCommand = Extract<ChartClientCommand, {
    type: 'subscribe_strategy_operations';
}>;
export type PreviewStrategyOperationCommand = Extract<ChartClientCommand, {
    type: 'preview_strategy_operation';
}>;
export type ApproveStrategyOperationCommand = Extract<ChartClientCommand, {
    type: 'approve_strategy_operation';
}>;
export type SubscribeStrategyRuntimeCommand = Extract<ChartClientCommand, {
    type: 'subscribe_strategy_runtime';
}>;
export type PauseStrategyTickerCommand = Extract<ChartClientCommand, {
    type: 'pause_strategy_ticker';
}>;
export type ResumeStrategyTickerCommand = Extract<ChartClientCommand, {
    type: 'resume_strategy_ticker';
}>;
export type UnlockStrategyTickerCommand = Extract<ChartClientCommand, {
    type: 'unlock_strategy_ticker';
}>;
export type AdoptStrategyPositionCommand = Extract<ChartClientCommand, {
    type: 'adopt_strategy_position';
}>;
export type AdoptStrategyPositionsCommand = Extract<ChartClientCommand, {
    type: 'adopt_strategy_positions';
}>;
export type CancelStrategyTickerOrdersCommand = Extract<ChartClientCommand, {
    type: 'cancel_strategy_ticker_orders';
}>;
export type ListBacktestRunsCommand = Extract<ChartClientCommand, {
    type: 'list_backtest_runs';
}>;
export type GetBacktestRunCommand = Extract<ChartClientCommand, {
    type: 'get_backtest_run';
}>;
export type GetBacktestProgressCommand = Extract<ChartClientCommand, {
    type: 'get_backtest_progress';
}>;
export type SubscribeBacktestProgressCommand = Extract<ChartClientCommand, {
    type: 'subscribe_backtest_progress';
}>;
export type GetBacktestChartOverlaysCommand = Extract<ChartClientCommand, {
    type: 'get_backtest_chart_overlays';
}>;
export type GetBacktestReportOverlaysCommand = Extract<ChartClientCommand, {
    type: 'get_backtest_report_overlays';
}>;
export type UnsubscribeCommand = Extract<ChartClientCommand, {
    type: 'unsubscribe';
}>;
export type SubscribeAlertsCommand = Extract<ChartClientCommand, {
    type: 'subscribe_alerts';
}>;
export type UpsertCandleStateCommand = Extract<ChartClientCommand, {
    type: 'upsert_candle_state';
}>;
export type PatchCandleStateCommand = Extract<ChartClientCommand, {
    type: 'patch_candle_state';
}>;
export type CandleStatesEvent = Extract<ChartFeedEventKind, {
    type: 'candle_states';
}>;
export type AuthPositionsEvent = Extract<ChartFeedEventKind, {
    type: 'auth_positions';
}>;
export type AuthPositionHistoryEvent = Extract<ChartFeedEventKind, {
    type: 'auth_position_history';
}>;
export type AuthPositionAuditEvent = Extract<ChartFeedEventKind, {
    type: 'auth_position_audit';
}>;
export type AuthPositionsUpdateEvent = Extract<ChartFeedEventKind, {
    type: 'auth_positions_update';
}>;
export type AuthPositionAuditUpdateEvent = Extract<ChartFeedEventKind, {
    type: 'auth_position_audit_update';
}>;
export type SubscriptionAcceptedEvent = Extract<ChartFeedEventKind, {
    type: 'subscription_accepted';
}>;
export type SubscriptionAcceptedSummaryEvent = Extract<ChartFeedEventKind, {
    type: 'subscription_accepted_summary';
}>;
export type HistoricalAckEvent = Extract<ChartFeedEventKind, {
    type: 'historical_ack';
}>;
export type HistoricalProgressEvent = Extract<ChartFeedEventKind, {
    type: 'historical_progress';
}>;
export type HistoricalChunkEvent = Extract<ChartFeedEventKind, {
    type: 'historical_chunk';
}>;
export type HistoricalChunkColumnarEvent = Extract<ChartFeedEventKind, {
    type: 'historical_chunk_columnar';
}>;
export type HistoricalCompleteEvent = Extract<ChartFeedEventKind, {
    type: 'historical_complete';
}>;
export type SearchAcceptedEvent = Extract<ChartFeedEventKind, {
    type: 'search_accepted';
}>;
export type SearchProgressEvent = Extract<ChartFeedEventKind, {
    type: 'search_progress';
}>;
export type SearchMatchEvent = Extract<ChartFeedEventKind, {
    type: 'search_match';
}>;
export type SearchCompleteEvent = Extract<ChartFeedEventKind, {
    type: 'search_complete';
}>;
export type SearchCancelledEvent = Extract<ChartFeedEventKind, {
    type: 'search_cancelled';
}>;
export type SearchFailedEvent = Extract<ChartFeedEventKind, {
    type: 'search_failed';
}>;
export type StrategiesEvent = Extract<ChartFeedEventKind, {
    type: 'strategies';
}>;
export type StrategyEvent = Extract<ChartFeedEventKind, {
    type: 'strategy';
}>;
export type StrategyRuntimesEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_runtimes';
}>;
export type StrategyRuntimeLifecycleEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_runtime_lifecycle';
}>;
export type StrategyRuntimeEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_runtime';
}>;
export type StrategyTickerEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_ticker';
}>;
export type StrategyChartOverlaysEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_chart_overlays';
}>;
export type StrategyDecisionsEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_decisions';
}>;
export type StrategyOperationsEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_operations';
}>;
export type StrategyOperationsUpdateEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_operations_update';
}>;
export type StrategyMoneyEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_money';
}>;
export type StrategyBalanceHistoryEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_balance_history';
}>;
export type StrategyAccountMoneyEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_account_money';
}>;
export type StrategyOperationPreviewEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_operation_preview';
}>;
export type StrategyOperationResultEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_operation_result';
}>;
export type StrategyAllocationComparisonEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_allocation_comparison';
}>;
export type StrategyRuntimeUpdateEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_runtime_update';
}>;
export type StrategyPromotionsEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_promotions';
}>;
export type StrategyPromotionEvent = Extract<ChartFeedEventKind, {
    type: 'strategy_promotion';
}>;
export type BacktestRunsEvent = Extract<ChartFeedEventKind, {
    type: 'backtest_runs';
}>;
export type BacktestRunEvent = Extract<ChartFeedEventKind, {
    type: 'backtest_run';
}>;
export type BacktestProgressEvent = Extract<ChartFeedEventKind, {
    type: 'backtest_progress';
}>;
export type BacktestProgressUpdateEvent = Extract<ChartFeedEventKind, {
    type: 'backtest_progress_update';
}>;
export type BacktestChartOverlaysEvent = Extract<ChartFeedEventKind, {
    type: 'backtest_chart_overlays';
}>;
export type BacktestReportOverlaysEvent = Extract<ChartFeedEventKind, {
    type: 'backtest_report_overlays';
}>;
export type LiveUpdateEvent = Extract<ChartFeedEventKind, {
    type: 'live_update';
}>;
export type ControlAckEvent = Extract<ChartFeedEventKind, {
    type: 'control_ack';
}>;
export type AlertListEvent = Extract<ChartFeedEventKind, {
    type: 'alert_list';
}>;
export type AlertEvent = Extract<ChartFeedEventKind, {
    type: 'alert';
}>;
export type ErrorEvent = Extract<ChartFeedEventKind, {
    type: 'error';
}>;
