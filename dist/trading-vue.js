...
(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.TradingVueJs = {}));
	...
	var DEF_LIMIT, BUF_INC, FDEFS, FDEFS1, FDEFS2, SBRACKETS, TFSTR, SECOND, MINUTE$1, MINUTE3, MINUTE5, MINUTE15$1, MINUTE30, HOUR$2, HOUR4, HOUR12, DAY$2, WEEK$2, MONTH$2, YEAR$2, MONTHMAP$1, TIMESCALES$1, $SCALES$1, OVERLAY_COLORS, ChartConfig, IB_TF_WARN, MAP_UNIT, constants_default;
	var init_constants = __esmMin((() => {
		DEF_LIMIT = 5;
		BUF_INC = 5;
		FDEFS = /(function |)([$A-Z_][0-9A-Z_$\.]*)[\s]*?\((.*?)\)/gim;
		FDEFS1 = /(function |)([$A-Z_][0-9A-Z_$\.]*)[\s]*?\((.*?\s*)\)/im;
		FDEFS2 = /(function |)([$A-Z_][0-9A-Z_$\.]*)[\s]*?\((.*\s*)\)/gims;
		SBRACKETS = /([$A-Z_][0-9A-Z_$\.]*)[\s]*?\[([^"^\[^\]]+?)\]/gim;
		TFSTR = /(\d+)(\w*)/gm;
		SECOND = 1e3;
		MINUTE$1 = SECOND * 60;
		MINUTE3 = MINUTE$1 * 3;
		MINUTE5 = MINUTE$1 * 5;
		MINUTE15$1 = MINUTE$1 * 15;
		MINUTE30 = MINUTE$1 * 30;
		HOUR$2 = MINUTE$1 * 60;
		HOUR4 = HOUR$2 * 4;
		HOUR12 = HOUR$2 * 12;
		DAY$2 = HOUR$2 * 24;
	...
	var EffectScope = class {
		...
		*/
		...
		run(fn) {
			...
			} else if (!!(process.env.NODE_ENV !== "production")) warn$3(`cannot run an inactive effect scope.`);
		}
		/**
	...
	function createReadonlyMethod(type) {
		return function(...args) {
			if (!!(process.env.NODE_ENV !== "production")) {
				...
				warn$3(`${capitalize(type)} operation ${key}failed: target is readonly.`, /* @__PURE__ */ toRaw(this));
			}
...
Component that was made reactive: `, type);
	...
	function finishComponentSetup(instance, isSSR, skipOptions) {
		...
		if (!!(process.env.NODE_ENV !== "production") && !Component.render && instance.render === NOOP && !isSSR) if (!compile$1 && Component.template) warn$1("Component provided template option but runtime compilation is not supported in this build of Vue. Configure your bundler to alias \"vue\" to \"vue/dist/vue.esm-bundler.js\".");
	...
	**/
	...
	function patchEvent(el, rawName, prevValue, nextValue, instance = null) {
		...
		if (nextValue && existingInvoker) existingInvoker.value = !!(process.env.NODE_ENV !== "production") ? sanitizeEventValue(nextValue, rawName) : nextValue;
			...
			if (nextValue) addEventListener$1(el, name, invokers[rawName] = createInvoker(!!(process.env.NODE_ENV !== "production") ? sanitizeEventValue(nextValue, rawName) : nextValue, instance), options);
...
`, -1);
	...
	function genNode(node, context) {
		...
		switch (node.type) {
			...
			case 9:
			case 11:
				process.env.NODE_ENV !== "production" && assert$2(node.codegenNode != null, `Codegen node is missing for element/if/for node. Apply appropriate transforms first.`);
			...
			default: if (!!(process.env.NODE_ENV !== "production")) {
				assert$2(false, `unhandled codegen node type: ${node.type}`);
				return node;
			}
		}
	}
	...
	* @license MIT
	**/
	var V_MODEL_RADIO = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vModelRadio` : ``);
	var V_MODEL_CHECKBOX = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vModelCheckbox` : ``);
	var V_MODEL_TEXT = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vModelText` : ``);
	var V_MODEL_SELECT = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vModelSelect` : ``);
	var V_MODEL_DYNAMIC = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vModelDynamic` : ``);
	var V_ON_WITH_MODIFIERS = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vOnModifiersGuard` : ``);
	var V_ON_WITH_KEYS = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vOnKeysGuard` : ``);
	var V_SHOW = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `vShow` : ``);
	var TRANSITION = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `Transition` : ``);
	var TRANSITION_GROUP = /* @__PURE__ */ Symbol(!!(process.env.NODE_ENV !== "production") ? `TransitionGroup` : ``);
	...
	var DOMNodeTransforms = [transformStyle, ...!!(process.env.NODE_ENV !== "production") ? [transformTransition, validateHtmlNesting] : []];
	...
	**/
	...
	function compileToFunction(template, options) {
		if (!isString(template)) if (template.nodeType) template = template.innerHTML;
			...
			process.env.NODE_ENV !== "production" && warn$2(`invalid template option: `, template);
			return NOOP;
		}
		...
		if (template[0] === "#") {
			...
			if (!!(process.env.NODE_ENV !== "production") && !el) warn$2(`Template element not found or is empty: ${template}`);
...
${codeFrame}` : message);
	...
	//#endregion
	//#region node_modules/arrayslicer/lib/index.js
...
pointers: 1 },
	...
	*/
	...
	function _sfc_render$14(_ctx, _cache, $props, $setup, $data, $options) {
		return $data.visible ? (openBlock(), createElementBlock("div", {
			...
			$props.ux.win_header !== false ? (openBlock(), createElementBlock("div", _hoisted_2$1, [createBaseVNode("div", {
		...
		*/
		drawBandFill(ctx, data, topIndex, bottomIndex) {
			...
			for (let i = 0; i < data.length; i++) {
				let p = data[i];
				let x = layout.t2screen(p[0]);
				let y = layout.$2screen(p[topIndex] || void 0);
				ctx.lineTo(x, y);
			}
			for (let i = data.length - 1; i >= 0; i--) {
				let p = data[i];
				let x = layout.t2screen(p[0]);
				let y = layout.$2screen(p[bottomIndex] || void 0);
				ctx.lineTo(x, y);
			}
			ctx.fill();
		},
		...
		methods: {
			...
			draw_value(ctx, dir, xm, y) {
				...
				let f2 = (t) => {
					...
					return (this.layout.candles || this.layout.master_grid.candles).indexOf(c);
				};
	...
	*/
	function validateOverlayComponent(comp) {
		...
		if (!isFn(m.draw)) out.push(warn("overlay.draw", `overlay "${label}" has no draw(ctx) method — it will not render`, label));
	...
	function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
		...
		return $props.common ? (openBlock(), createElementBlock("div", {
			...
			$options.show_values ? (openBlock(), createElementBlock("span", _hoisted_1$3, [
				...
				createBaseVNode("span", _hoisted_2, toDisplayString($options.ohlcv[0]), 1),
			...
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("span", _hoisted_7, toDisplayString(ind.name), 1),
	...
	var Botbar = class {
		...
		format_date(p) {
			...
			if (p[2] === YEAR$1 || utils_default.year_start(t) === t) return d.getUTCFullYear();
			if (p[2] === MONTH$1 || utils_default.month_start(t) === t) return MONTHMAP[d.getUTCMonth()];
	...
	function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
		...
		}, null, 4), _cache[2] || (_cache[2] = createBaseVNode("div", { class: "resizer-hitbox" }, null, -1))], 38);
	}
	...
	var TIMESCALES, $SCALES, WEEK, MONTH, YEAR, HOUR, DAY, MAX_INT;
	var init_grid_maker = __esmMin((() => {
		init_constants();
		init_utils();
		init_math();
		init_layout_fn();
		init_log_scale();
		({TIMESCALES, $SCALES, WEEK, MONTH, YEAR, HOUR, DAY} = constants_default);
	...
	var _sfc_main$6 = {
		...
		created() {
			...
			utils_default.overwrite(this.range, this.range);
			const Layout = (init_layout(), __toCommonJS(layout_exports)).default;
			const rangeArr = [this.range[0], this.range[1]];
			const subArr = Array.from(this.sub);
			const layoutParams = {
				chart: this.chart,
	...
	function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
		return openBlock(), createElementBlock("div", {
			...
			}, null, 4), createBaseVNode("div", null, toDisplayString(item.type), 1)], 14, _hoisted_1$1)) : createCommentVNode("", true)], 64);
		}), 128))], 36);
	}
	var ItemList_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$5, [["render", _sfc_render$5]]);
	//#endregion
	...
	var _sfc_main$4 = {
		...
		components: { ItemList: ItemList_default },
		mounted() {
			if (this.data.group) {
	...
	*/
	...
	exports.Interface = interface_default;
	exports.Overlay = overlay_default;
	exports.Tool = tool_default;
	exports.TradingVue = TradingVue_default;
